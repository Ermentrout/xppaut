...
static void edit_diagram(DIAGRAM *d, int ibr, int ntot, int itp, int lab, int nfpar, double a, double *uhi, double *ulo, double *u0, double *ubar, double *par, double per, int n, int icp1, int icp2, int icp3, int icp4,int flag2, double *evr, double *evi, double tp);
...
/* --- Static functions --- */
static void edit_diagram(DIAGRAM *d, int ibr, int ntot, int itp, int lab, int nfpar,
