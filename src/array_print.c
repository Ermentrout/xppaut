...
void  ps_replot(float **z, int col0, int row0, int nskip, int ncskip,
...
void ps_col_scale(double y0, double x0, double dy, double dx,
...
void ps_boxit(double tlo, double thi, double jlo, double jhi, double zlo, double zhi,
